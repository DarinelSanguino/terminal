...
#define TERM_KEY_CAN					(_KEY_INIT(0x18))
#define TERM_KEY_RESET					'~'						// Reset CPU

// **************************************************************************

// ********************** Terminal Settings *********************************
extern void _reset_fcn(void);
...
#define CHAR_INTERRUPT			TERM_KEY_CAN	 	// Abort execute command key-code symbol
...
#define CLI_GetUs()					(Time_get_counter())	// System time in us
#define CLI_GetFastUs()				(Time_get_counter())			// System time in us (not exact)
#define CLI_GetFastMs()				(Time_get_counter() * 1000U)		// System time in ms (not exact)
#define CLI_CounterReset()			(Time_reset_counter())
